...
if not st.session_state.autenticado:
    ...
    with c_izq:
        st.markdown("""<div class='info-box'>
            🛡️ PROTECCIÓN TOTAL<br><br>
            Cifrado de grado militar AES-256. Sus activos en Puerto Madero y el mundo bajo custodia digital absoluta.
    ...
    with c_der:
        st.markdown("""<div class='info-box'>
            📈 CRECIMIENTO<br><br>
            Inteligencia Artificial de predicción macroeconómica. Optimización de rentabilidad en tiempo real.
        </div>""", unsafe_allow_html=True)
