...
# --- 2. DISEÑO IMPERIAL (TEXTO FORZADO) ---
st.set_page_config(page_title="LEGACY VAULT", layout="wide", initial_sidebar_state="collapsed")
st.markdown("""
    <style>
    /* MATA LA FLECHA SIN BORRAR NADA MÁS */
    ...
    /* FORZAR QUE EL TEXTO DE LOS BOTONES APAREZCA */
    button p { color: #000000 !important; font-weight: bold !important; font-size: 1.2rem !important; }
...
if not st.session_state.auth:
    ...
    with col_c:
        ...
        if st.button("🔓 UNLOCK VAULT / ACCEDER"):
            ...
            else: st.error("DENEGADO. Escribí a dylanelpromaster25@gmail.com")
    st.stop()
