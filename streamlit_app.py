...
# --- 4. ACCESO AL BÚNKER (FACHADA VIP) ---
    ...
    with col_c:
        ...
        if st.button("🔓 UNLOCK VAULT"):
            if pw_in == "LEGACY2026" and emp_raw in VIP:
                ...
                # EL ERROR QUE VENDE: TU EMAIL DE SOPORTE
...
if q:
    with st.spinner("Analizando..."):
        time.sleep(1); st.markdown(f"<div class='gold-card'>🏛️ <b>ADVISOR:</b> Análisis completado para {emp}. Estado: SOLVENTE.</div>", unsafe_allow_html=True)
...
with r1: st.markdown("<div class='gold-card'>🗽 NY: 06:15 PM</div>", unsafe_allow_html=True)
with r2: st.markdown("<div class='gold-card'>🏢 BA: 08:15 PM</div>", unsafe_allow_html=True)
with r3: st.markdown("<div class='gold-card'>🏰 LN: 11:15 PM</div>", unsafe_allow_html=True)
