...
if not st.session_state.auth:
    ...
    with col_c:
        ...
        if region == "USA / GLOBAL":
            ...
            # BOTÓN PAYPAL MUNDIAL
            st.markdown(f'<a href="mailto:dylanelpromaster25@://gmail.com" class="btn-paypal">🔵 PAY WITH PAYPAL</a>', unsafe_allow_html=True)
            st.markdown(f'<a href="mailto:dylanelpromaster25@://gmail.com" class="btn-paypal" style="background:#d4af37; color:black;">📩 REQUEST VIP KEY (EMAIL)</a>', unsafe_allow_html=True)
        else:
            st.write("Suscripción: **$2.000.000 ARS**")
            # BOTONES ARGENTINA (MP Y DNI)
